...
class WorkoutDifficultyComparatorTest {

    WorkoutDifficultyComparator comparator = new WorkoutDifficultyComparator();


    @Test
    void testCompareCorrect() {
        Workout workout1 = new CardioWorkout("ABC", 90, 250, 4);
        Workout workout2 = new StrengthWorkout("ABD", 80, 200, 5);
        assertTrue(comparator.compare(workout1,workout2) < 0, "Compare should be negative.");
        Workout workout3 = new YogaSession("ABD", 80, 200, 4);
        assertTrue(comparator.compare(workout1,workout3) < 0, "Compare should be negative.");
        Workout workout4 = new YogaSession("ABD", 80, 250, 4);
        assertTrue(comparator.compare(workout1,workout4) < 0, "Compare should be negative.");
        Workout workout5 = new YogaSession("ABD", 90, 250, 4);
        assertTrue(comparator.compare(workout1,workout5) < 0, "Compare should be negative.");
        Workout workout6 = new YogaSession("ABC", 90, 250, 4);
        assertTrue(comparator.compare(workout1,workout6) < 0, "Compare should be negative.");
        Workout workout7 = new CardioWorkout("ABC", 90, 250, 4);
