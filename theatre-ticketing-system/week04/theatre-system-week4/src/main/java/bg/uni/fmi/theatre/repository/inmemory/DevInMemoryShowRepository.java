...
public class DevInMemoryShowRepository implements ShowRepository {
    ...
    @PostConstruct
    public void seed() {
        save(new Show(nextId(), "Hamlet", "Shakespeare's tragedy", Genre.DRAMA, 120,
            AgeRating.PG_16));
        save(new Show(nextId(), "Chicago", "Broadway musical", Genre.MUSICAL, 135,
            AgeRating.PG_12));
        ...
        save(new Show(nextId(), "The Phantom of the Opera", "Epic musical", Genre.MUSICAL,
            150, AgeRating.PG_12));
        save(new Show(nextId(), "Swan Lake", "Tchaikovsky's ballet", Genre.BALLET, 140,
            AgeRating.ALL));
    }
