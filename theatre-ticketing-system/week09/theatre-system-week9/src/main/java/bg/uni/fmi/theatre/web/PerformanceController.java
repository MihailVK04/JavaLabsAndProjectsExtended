...
public class PerformanceController {
    ...
    @Operation(summary = "Created performance", description = "Schedule a new performance")
    ...
    public PerformanceResponse createdPerformance(@Valid @RequestBody PerformanceRequest req) {
